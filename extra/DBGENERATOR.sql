CREATE OR REPLACE TABLE clientes ( 
	...
	identificacion_numero VARCHAR(20) NOT NULL UNIQUE, 
	identificacion_tipo VARCHAR(3) NOT NULL, 
	nombre VARCHAR(50) NOT NULL, 
	apellidos VARCHAR(50), 
	direccion VARCHAR(50) NOT NULL, 
	telefonos VARCHAR(100) NOT NULL, 
	est_borrado SMALLINT DEFAULT 0 NOT NULL, 
	fec_mod DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, 
	fec_crea DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL
);
